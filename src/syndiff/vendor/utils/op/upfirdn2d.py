...
def upfirdn2d(input, kernel, up=1, down=1, pad=(0, 0)):
    if input.device.type == "cpu":
        ...
        # The CUDA kernel only supports fp32. When called inside an AMP
        # autocast region with bf16/fp16 inputs we transparently cast in
        # and out so callers don't have to.
